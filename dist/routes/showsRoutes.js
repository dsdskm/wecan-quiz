...
// Show 배경 이미지 업로드 라우트
router.post('/:showId/background-image', auth_1.authenticateToken, storage_1.upload.single('backgroundImage'), showsController_1.uploadShowBackgroundImage); // uploadShowBackgroundImage 컨트롤러 함수 사용
// Show 배경 이미지 삭제 라우트
